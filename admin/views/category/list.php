                    ...
                    <div class="card strpied-tabled-with-hover">
                        <div class="card-header ">
                            ...
                            <div class="pull-left col-md-5 text-left">
                                <a class="btn btn-primary" href="<?= SITEURL . CONTROLLERS ?>categoriesController.php?action=add"><i class="nc-icon nc-simple-add"></i> افزودن</a>
                            </div>
                        </div>
                        <div class="card-body table-full-width table-responsive">
                            <table class="table table-hover table-striped">
                                ...
                                if(isset($data['categories']) AND $data['categories'] AND count($data['categories'])>0)
                                    foreach ($data['categories'] AS $category) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="categoriesController.php?action=edit&id=<?= $category['id'] ?>"><i
                                                            class="nc-icon nc-ruler-pencil"></i></a>
                                                <a href="categoriesController.php?action=delete&id=<?= $category['id'] ?>"><i
